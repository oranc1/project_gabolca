...
<link
	...
	rel="stylesheet">
<link
	href="${pageContext.request.contextPath }/resources/css/member/mem_page/mem_res_detail.css"
	rel="stylesheet">
<link
		...
		<div class="inq_container">
			...
			<div class="res-detail-cont">
				...
				<article class="res_detail_article2">
							...
							<div class="res_con_wrap">
								...
								<ul class="side_sub ss_r">
									...
									<li><fmt:formatDate value="${resinfo.res_return_date}"
											pattern="yyyy-MM-dd HH:mm" /><br> <br></li>
									<li class="res_detail_totalcost"><fmt:formatNumber
											value="${payment.pay_total}" pattern="###,###" /> 원</li>
					...
					<script
						src="${pageContext.request.contextPath }/resources/js/member/mem_page/mem_res_detail.js"></script>
				</article>
			</div>
		</div>
	</section>
