		            			...
		            			+"<div class='table'>"
		              				+"<h3>요금정보</h3>"
		              					+"<table class='custom-table' border='1'>"
		                					...
		                					+"<tr>"
							                  	+"<td>24시간</td>"
							                  	+"<td><span>"+Number(car.car_weekdays).toLocaleString()+"</span>원</td>"
							                  	+"<td><span>"+Number(car.car_weekend).toLocaleString()+"</span>원</td>"
							                +"</tr>"
					    					+"<tr>"
					        					+"<td>6시간</td>"
					        					+"<td>"+Number(car.car_weekdays * 0.5).toLocaleString()+"원</td>"
					        					+"<td>"+Number(car.car_weekend * 0.5).toLocaleString()+"원</td>"
					    					+"</tr>"
					    					+"<tr>"
					        					+"<td>1시간</td>"
					        					+"<td>"+Number(car.car_weekdays * 0.5 * 0.5).toLocaleString()+"원</td>"
					        					+"<td>"+Number(car.car_weekend * 0.5 * 0.5).toLocaleString()+"원</td>"
					    					+"</tr>"
		              				+"</table>"
		            			+"</div>"
